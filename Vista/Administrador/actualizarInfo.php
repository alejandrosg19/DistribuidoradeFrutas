...
if (isset($_POST["Actualizar"])) {
    ...
    if ($band == 1) {
        ...
        $date = date('Y-m-d');
        $hora = date('H:i:s');
        $log = new Log("", 'Actualizar Información', $infoLog, $date, $hora, "Administrador", $administradorAux->getIdAdministrador());
        $log->insertarLog();
    } else {
                        ...
                        <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                            <form action="index.php?pid= <?php echo base64_encode("Vista/Administrador/actualizarInfo.php") ?>" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="Nombre" id="Nombre" value="<?php echo $administrador->getNombre() ?>" require>
                                </div>
                                <div class="form-group">
                                    <label for="Correo">Direccion de correo electrónico</label>
                                    <input type="email" class="form-control" name="Correo" id="Correo" value="<?php echo $administrador->getCorreo() ?>" aria-describedby="emailHelp" require>
