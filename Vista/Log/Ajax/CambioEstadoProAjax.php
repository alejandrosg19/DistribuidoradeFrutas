                        ...
                        <div class="d-flex justify-content-between ">
                            <div>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <p class="m-0"><small id="emailHelp" class="form-text text-muted mt-0 "><?php echo ($info2[1]==0?"Sin Stock":"Stock")?></small></p>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <p class="m-0">Estado: </p>
                                    <p class="m-0"><small id="emailHelp" class="form-text text-muted mt-0 "><?php echo ($producto->getEstado()==0?"Sin Stock":"Stock")?></small></p>
                                </div>
                            </div>
                        </div>
                    </div>
