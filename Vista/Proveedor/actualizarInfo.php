...
if (isset($_POST["Actualizar"])) {
    $proveedor = new Proveedor($_SESSION["id"], $_POST["Nombre"], $_POST["Correo"]);
            ...
            <div class="card text-center">
                ...
                <div class="card-body">
                    <div class="row p-3">
                        ...
                        <div class="col-9">
                            <form action="index.php?pid= <?php echo base64_encode("Vista/Proveedor/actualizarInfo.php") ?>" method="POST">
