...
if ($_POST["Rol"] == "Proveedor") {
    ...
    if ($proveedor->validarCorreo()) {
        header("Location: index.php?pid=" . base64_encode("Vista/Main/mainPrincipal.php") . "&validacion=1");
    } else {
        $proveedor->registrarProveedor();
        header("Location: index.php?pid=" . base64_encode("Vista/Main/mainPrincipal.php") . "&validacion=2");
    }
